...
resource "aws_ecr_repository" "gh_api_api_container_repo_qa" {
    name                 = "gh-api-api-container-repo-qa"
...
resource "aws_ecr_repository" "gh_api_api_container_repo_prod" {
    name                 = "gh-api-api-container-repo-prod"
    image_tag_mutability = "MUTABLE"
