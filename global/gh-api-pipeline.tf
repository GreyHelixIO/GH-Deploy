...
resource "aws_ecr_repository" "gh_api_container_repo_qa" {
    name                 = "gh-api-container-repo-qa"
...
resource "aws_ecr_repository" "gh_api_container_repo_stage" {
    name                 = "gh-api-container-repo-stage"
    image_tag_mutability = "MUTABLE"
...
resource "aws_ecr_repository" "gh_api_container_repo_prod" {
    name                 = "gh-api-container-repo-prod"
    image_tag_mutability = "MUTABLE"
